...
satInstance = SATInstance.from_file("DNAComputationSim/simulator/sat/satInput.txt")
SATInstance.to_assignment_graph_file(satInstance.variables, "DNAComputationSim/simulator/sat/satOutput.txt")
pass
